...
\begin{align*}
   ...
   less_{PoS}^{min.} = &~ \left ( \overline{b_{0}}+a_{1} \right )\cdot \left  ( \overline{b_{1}}+a_{1} \right ) \cdot \left ( a_{1}+a_{0} \right )\cdot \left ( \overline{b_{1}}+\overline{b_{0}} \right )\cdot \left ( \overline{b_{1}}+a_{0} \right )
